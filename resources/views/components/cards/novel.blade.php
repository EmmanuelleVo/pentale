...
<div class="novel__item swiper-slide">
    <figure class="novel__item-figure">
        <a href="/novels/{{ $book->book_slug }}" class="u-absolute" title="Learn more about {{ $book->book_title }}"></a>
    ...
    <div class="novel__item-content">
        <h3 class="title title--card" aria-level="3" role="heading">
            <a href="/novels/{{ $book->book_slug }}" title="Learn more about {{ $book->book_title }}">
                {{ \Illuminate\Support\Str::limit($book->book_title, 40, $end='...') }}
            </a>
        </h3>
