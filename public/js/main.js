...
/***/ "./resources/js/components/Accordion.ts":
/*!**********************************************!*\
  !*** ./resources/js/components/Accordion.ts ***!
  \**********************************************/
...
var Accordion = /** @class */function () {
  function Accordion() {
    ...
    if (this.accordionContainer) {
      this.accordionBtn.addEventListener('click', function (e) {
        e.preventDefault();
        if (_this.accordionContainer.clientHeight) {
          _this.accordionContainer.style.height = '0px';
        } else {
          _this.accordionContainer.style.height = _this.accordionContent.clientHeight + "px";
        }
      });
    }
  }
...
/***/ "./resources/js/components/Commons.ts":
/*!********************************************!*\
  !*** ./resources/js/components/Commons.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
var Modal = /** @class */function () {
  function Modal() {
    ...
    if (this.modal && this.modalBtn) {
      this.modalBtn.addEventListener('click', function (e) {
        e.preventDefault();
        _this.open();
      });
    }
    ...
    if (quantities && quantities.length !== 0) {
      ...
      if (quantities instanceof Array) {
        quantities.forEach(function (div) {
          return div.quantity = new quantity_js_1["default"](div, 'Down', 'Up', div.dataset.number, div.dataset.label);
        });
      }
    }
  }
...
var ProgressBar = /** @class */function () {
  function ProgressBar() {
    ...
    if (this.progressBar) {
      ...
      document.querySelectorAll('.chapter__body').forEach(function (section) {
        observer_1.observe(section);
      });
      window.addEventListener('scroll', function (e) {
        var winScroll = document.body.scrollTop || document.documentElement.scrollTop;
        var height = _this.chapterBody.scrollHeight - document.documentElement.clientHeight; //2829 px
        var scrolled = winScroll / height * 100; // percentage
...
/***/ "./resources/js/components/Star.ts":
/*!*****************************************!*\
  !*** ./resources/js/components/Star.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, exports) => {
  ...
  function Star() {
    ...
    if (this.containers) {
      this.containers.forEach(function (container) {
        var average = container.querySelector('.book__average').textContent - 1;
        container.querySelectorAll('.star').forEach(function (star) {
          for (var i = 0; i < container.querySelectorAll('.star').length; i++) {
            if (i <= average) {
    ...
    if (this.bookAverage) {
      ...
      this.stars.forEach(function (item) {
        for (var i = 0; i < _this.stars.length; i++) {
          if (i <= _this.number) {
            _this.stars[i].classList.replace('bx-star', 'bxs-star');
            _this.stars[i].classList.add('active');
          }
        }
      });
    }
...
var Modal_1 = __webpack_require__(/*! ./components/Modal */ "./resources/js/components/Modal.ts");
var Accordion_1 = __webpack_require__(/*! ./components/Accordion */ "./resources/js/components/Accordion.ts");
var Commons_1 = __webpack_require__(/*! ./components/Commons */ "./resources/js/components/Commons.ts");
...
var QuantityInput = /*#__PURE__*/function () {
  function QuantityInput(self, decreaseText, increaseText) {
    ...
    if (this.input.label === 'fontSize') {
      document.querySelectorAll('.chapter .wysiwyg p').forEach(function (el) {
        el.style.fontSize = _this.input.value.toString() + 'px';
      });
    }
    if (this.input.label === 'lineHeight') {
      document.querySelectorAll('.chapter .wysiwyg *').forEach(function (div) {
        div.style.lineHeight = _this.input.value.toString() + 'px !important';
      });
    }
    ...
    function Button(text, className, label, value) {
      ...
      this.button.setAttribute('wire:click', "changePreferences('" + label + "','" + value + "')");
      return this.button;
    }
    ...
    self.querySelector('.sub').addEventListener('click', function () {
      return _this.change_quantity(-1, self);
    });
    self.querySelector('.add').addEventListener('click', function () {
      return _this.change_quantity(1, self);
    });
  ...
  _createClass(QuantityInput, [{
    key: "change_quantity",
    value: function change_quantity(change, self) {
      var _this2 = this;
      // Get current value
      ...
      if (this.input.label === 'fontSize') {
        ...
        document.querySelectorAll('.chapter .wysiwyg p').forEach(function (el) {
          el.style.fontSize = _this2.input.value.toString() + 'px';
        });
      }
      if (this.input.label === 'lineHeight') {
        document.querySelectorAll('.chapter .wysiwyg *').forEach(function (div) {
          div.style.lineHeight = _this2.input.value.toString() + 'px';
        });
      }
    }
  }]);
...
/******/ 	__webpack_require__.O(undefined, ["css/main"], () => (__webpack_require__("./resources/js/main.ts")))
