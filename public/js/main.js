...
/***/ "./resources/js/components/FileInput.ts":
/*!**********************************************!*\
  !*** ./resources/js/components/FileInput.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports) => {
  ...
  function FileInput() {
    ...
    if (this.input) {
      this.input.addEventListener('change', function (e) {
        ...
        if (file) {
          _this.img.src = URL.createObjectURL(file);
        }
      });
    }
  }
...
var Tabs = /** @class */function () {
  ...
  Tabs.prototype.openTab = function () {
    var _this = this;
    this.tabLinks.forEach(function (tabLink) {
      tabLink.addEventListener('click', function (e) {
        ...
        if (id) {
          _this.tabLinks.forEach(function (link) {
            link.classList.remove('tab__link--active');
          });
          tabLink.classList.add('tab__link--active');
          _this.tabContents.forEach(function (content) {
...
var FileInput_1 = __webpack_require__(/*! ./components/FileInput */ "./resources/js/components/FileInput.ts");
...
var Main = /** @class */function () {
  function Main() {
    ...
    var fileInput = new FileInput_1.FileInput();
